...
-- Audio
-- Noctalia changes PipeWire volume and displays its native OSD.
...
-- Match the portable dotfile convention: Command/Super + number switches
-- workspaces, and Command/Super + Shift + number moves the active window.
-- The old CachyOS defaults used these keys for monitor focus even when all
-- MONITOR variables were empty, making the shortcuts appear to do nothing.
for i = 1, 10 do
    local key = i % 10
